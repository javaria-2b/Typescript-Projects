    ...
    async function user_dashboard() {
        ...
        switch (dashboard.operations) {
            case "Profile": {
                ...
                console.log(chalk.yellow(` Courses Enrolled: ${stu?.coursesEnrolled
...
export async function instructors_login() {
    ...
    let ins = instructorsData.find((x) => x.instructorEmail === user._email &&
        x.instructorPassword === user._password); // to access current instructors in dataBase
    if (ins) {
    ...
    async function user_dashboard() {
        ...
        switch (dashboard.operations) {
            case "Profile": {
                ...
                console.log(chalk.green(`Courses Teaching: ${ins?.courses
                    .flatMap((x) => x.course_name)
                    .join(", ")}`));
                break;
            }
